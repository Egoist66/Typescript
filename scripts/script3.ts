...
///console.log(startServer("https", 3001))

type createAnimationType = {
    id: string | number
    animationName: string
    timingFunction: 'ease' | 'ease-out' | 'ease-in' | 'ease-in-out'
    duration: string
    iterationCount: 'infinity' | number

}

function createAnimation({id, animationName, timingFunction = 'ease', duration, iterationCount}: createAnimationType) {
